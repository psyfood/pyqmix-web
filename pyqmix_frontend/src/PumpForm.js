...
import TargetVolumeForm from "./TargetVolumeForm";
...
class PumpForm extends Component {
  ...
  handlePumpConfiguration = async (e) => {
    ...
    if (this.state.isPumpConfigSetUp === false && this.state.webConnectedToPumps === false) {
      ...
      let payload;
      payload = {
        'configName': this.state.selectedQmixConfig,
        ...
        <div className="button-group">
          ...
          <Modal isOpen={this.state.modal['noConfigOrDllFound']}
            ...
            <ModalBody>
              Ensure that:
              <ul>
                <li>You followed the gustometer installation <a
                  href="https://github.com/psyfood/pyqmix#gustometer-setup">instructions.</a></li>
                ...
                <li>If the above approaches are unsuccessful, then try adding the directory of the Qmix SDK DLL's to the
              ...
              <div className="row">
                <div className="col-sm input-subform button-subform">
                  ...
                  <Modal isOpen={this.state.modal['referenceMove']}
                    ...
                    <ModalFooter>
                      <Button color="success"
                              onClick={() => this.handlePumpOperation('referenceMove')}> Continue </Button>
              ...
              <div className="row">
                ...
                <div className="col-sm input-subform button-subform">
                  <Button color="success"
                          disabled={this.state.selectedPumps.length === 0}
                  > Bubble Cycle </Button>
                  <FormText>Guided procedure to remove air bubbles trapped in the syringe. Ends with a filled
                    syringe.</FormText>
